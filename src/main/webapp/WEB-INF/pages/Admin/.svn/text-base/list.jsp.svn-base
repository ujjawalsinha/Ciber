...
<head>
	...
	<meta name="description" content="<title>Cadreon Audience Marketplace</title>.">
...
<body>
	...
	<!-- topbar ends -->
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">${current.role}</td>
								<td class="center">
		...
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">Cadreon Audience Marketplace</a> 20132</p>
