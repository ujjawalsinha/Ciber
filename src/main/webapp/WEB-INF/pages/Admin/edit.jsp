	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"> <img alt="Charisma Logo" src="img/logo20.png" /> <span>Cadreon</span></a>
...
<form:form action="${pageContext.request.contextPath}/AdminSave" method="POST" modelAttribute="admin1">
 ...
 <div class="control-group warning">
								...
								<div class="controls">
								  ...
								  <form:input type="text" id="admin1_id" path="id"/>
								...
								<div class="controls">
								  <input type="text" id="admin1_username" path="username">
								...
								<div class="controls">
								  <input type="text" id="admin1_password" path="password">
								    
								
								</div>
								
								 <div class="control-group warning">
								<label class="control-label" for="inputWarning">Confirm password</label>
								<div class="controls">
								 <input type="text" id="admin1_password" path="password">
								...
								<label class="control-label" for="selectError3">Plain Role</label>
								<div class="controls">
								  <select id="admin1_role">
									<option>Admin</option>
									<option>Sys Admin</option>
									<option>Normal User</option>
									<option>Finance user</option>
									<option>Operation user</option>
								  </select>
								</div>
